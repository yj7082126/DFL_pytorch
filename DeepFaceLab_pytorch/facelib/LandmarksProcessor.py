...
[ 0.000213256,  0.106454  ], [ 0.0752622,    0.038915  ], [ 0.18113,      0.0187482 ], 
[ 0.29077,      0.0344891 ], [ 0.393397,     0.0773906 ], [ 0.586856,     0.0773906 ], #22
[ 0.689483,     0.0344891 ], [ 0.799124,     0.0187482 ], [ 0.904991,     0.038915  ], #25
[ 0.98004,      0.106454  ], [ 0.490127,     0.203352  ], [ 0.490127,     0.307009  ], #28
[ 0.490127,     0.409805  ], [ 0.490127,     0.515625  ], [ 0.36688,      0.587326  ], #31
[ 0.426036,     0.609345  ], [ 0.490127,     0.628106  ], [ 0.554217,     0.609345  ], #34
[ 0.613373,     0.587326  ], [ 0.121737,     0.216423  ], [ 0.187122,     0.178758  ], #37
[ 0.265825,     0.179852  ], [ 0.334606,     0.231733  ], [ 0.260918,     0.245099  ], #40
[ 0.182743,     0.244077  ], [ 0.645647,     0.231733  ], [ 0.714428,     0.179852  ], #43
[ 0.793132,     0.178758  ], [ 0.858516,     0.216423  ], [ 0.79751,      0.244077  ], #46
[ 0.719335,     0.245099  ], [ 0.254149,     0.780233  ], [ 0.340985,     0.745405  ], #49
[ 0.428858,     0.727388  ], [ 0.490127,     0.742578  ], [ 0.551395,     0.727388  ], #52
[ 0.639268,     0.745405  ], [ 0.726104,     0.780233  ], [ 0.642159,     0.864805  ], #55
[ 0.556721,     0.902192  ], [ 0.490127,     0.909281  ], [ 0.423532,     0.902192  ], #58
[ 0.338094,     0.864805  ], [ 0.290379,     0.784792  ], [ 0.428096,     0.778746  ], #61
[ 0.490127,     0.785343  ], [ 0.552157,     0.778746  ], [ 0.689874,     0.784792  ], #64
[ 0.553364,     0.824182  ], [ 0.490127,     0.831803  ], [ 0.42689 ,     0.824182  ]  #67
], dtype=np.float32)
...
def convert_98_to_68(lmrks):
    ...
    result += [ 
         lmrks[33], 
        (lmrks[34]+lmrks[41])/2, (lmrks[35]+lmrks[40])/2,
        (lmrks[36]+lmrks[39])/2, (lmrks[37]+lmrks[38])/2,
    ]

    result += [ 
        (lmrks[42]+lmrks[50])/2, (lmrks[43]+lmrks[49])/2,
        (lmrks[44]+lmrks[48])/2, (lmrks[45]+lmrks[47])/2,
         lmrks[46]
    ]
...
def get_simple_transform_mat (image_landmarks, output_size, padding, scale=1.0, lower_factor=0.15):
    if not isinstance(image_landmarks, np.ndarray):
        image_landmarks = np.array (image_landmarks)

    # estimate landmarks transform from global space to local aligned space with bounds [0..1]
    mat = umeyama(np.concatenate([
